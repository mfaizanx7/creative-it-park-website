...
const mainFunction = () => {
  ...
  swipers.forEach(
    (s) => s && typeof s.el === "object" && s.destroy(true, true)
  );
  // console.log(swipers);
  swipers = [];
      ...
      $(window).on("load", () => {
        ...
        if ($(".loader .logo").length) {
          ...
          $(".loader .logo").on("animationend", (event) => {
            ...
            if (
              event.originalEvent.animationName !== "loader-fadeoutAnimation"
            ) {
          ...
          setTimeout(() => {
            if (!animationsCompleted) {
              console.warn(
                "Animations did not complete in time. Hiding loader manually."
              );
              $(".loader .logo").addClass("loader-fadeoutAnimation");
              hideLoader(300);
            }
  ...
  const toggleMenuOnMobile = () => {
    $(".mil-menu-btn")
      .off("click") // remove previous handler
      .on("click", function () {
        console.log("Menu Button Clicked", $(this), $(".mil-navigation"));
  ...
  swipers[swiperIndex++] = new Swiper(".mil-banner-slideshow", {
    slidesPerView: 1,
    spaceBetween: 0,
    speed: 1500,
    autoplay: true,
  ...
  swipers[swiperIndex++] = new Swiper(".mil-banner-slider", {
    slidesPerView: 1,
    spaceBetween: 0,
    speed: 1500,
    autoplay: true,
  ...
  swipers[swiperIndex++] = new Swiper(".mil-works-slider", {
    slidesPerView: 1,
    spaceBetween: 30,
    speed: 800,
    navigation: {
  ...
  swipers[swiperIndex++] = new Swiper(".mil-blog-slider", {
    spaceBetween: 30,
    speed: 800,
    slidesPerView: 1,
    navigation: {
  ...
  swipers[swiperIndex++] = new Swiper(".mil-revi-slider", {
    slidesPerView: 1,
    spaceBetween: 30,
    speed: 800,
    mousewheel: true,
  ...
  swipers[swiperIndex++] = new Swiper(".mil-revi-slider-2", {
    slidesPerView: 1,
    spaceBetween: 30,
    speed: 800,
    autoplay: {
  ...
  var swiperServices = (swipers[swiperIndex++] = new Swiper(
    ".mil-services-slider",
    {
      slidesPerView: "auto",
      spaceBetween: 30,
  ...
  var swiperEvents = (swipers[swiperIndex++] = new Swiper(
    ".mil-events-slider",
    {
      slidesPerView: 1,
      spaceBetween: 30,
  ...
  var CourseSwiper = (swipers[swiperIndex++] = new Swiper(
    ".mil-courses-slider",
    {
      slidesPerView: 1,
      spaceBetween: 30,
  ...
  swipers[swiperIndex++] = new Swiper(".mil-banners-slider", {
    slidesPerView: 1,
    spaceBetween: 30,
    speed: 800,
    autoplay: {
  ...
  var swiperpartners = (swipers[swiperIndex++] = new Swiper(
    ".mil-partners-slider",
    {
  ...
  swipers[swiperIndex++] = new Swiper(".mil-box-slider", {
    slidesPerView: 1,
    spaceBetween: 30,
    speed: 800,
    parallax: true,
  ...
  swipers[swiperIndex++] = new Swiper(".mil-tabs-slider", {
    slidesPerView: 1,
    speed: 800,
  ...
  swipers[swiperIndex++] = new Swiper(".mil-tabs-slider-2", {
    slidesPerView: 1,
    speed: 800,
    allowTouchMove: false,
    hashNavigation: {
...
// If no saved language, try IP-based detection (DISABLED: Use Manual Selection)
if (!savedLang) {
  /*
  fetch("https://ipwhois.app/json/")
    ...
    */
  setPageLanguage("en"); // Default to English for all countries
} else {
  // console.log('autoset else')
  setPageLanguage(userLang);
}
...
function setPageLanguage(langCode) {
  ...
  $(".languageText").text(langCode.toUpperCase());
  loadTranslateScript();
}
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  $(".languageText").text(savedLang.toUpperCase());
