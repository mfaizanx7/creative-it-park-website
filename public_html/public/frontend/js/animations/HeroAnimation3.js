const c = document.getElementById("HeroAnimation1");
const range = window.innerWidth < 1440 ? 180 : 200;
const sizeMultiplier = window.innerWidth < 1440 ? .7 : .8;
var w = c.width = document.getElementsByClassName("mil-banner")[0].clientWidth,
		h = c.height = document.getElementsByClassName("mil-banner")[0].clientHeight,
		ctx = c.getContext( '2d' ),
		opts = {
