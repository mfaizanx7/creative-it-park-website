                        ...
                        <tr>
                            ...
                            <td class="actions-cell">
                                <div class="buttons right nowrap">
                                    <a href="{{ route('admin.industry.edit', $user->id) }}" class="button small blue">
                                        <i class="mdi mdi-pencil" style="font-size: 16px;"></i>
                                    </a>
                                    <form action="{{ route('admin.industry.destroy', $user->id) }}" method="post" onsubmit="return confirm('Are you sure?')" style="display: inline-block; margin: 0;">
                                        @csrf
                                        @method('DELETE')
