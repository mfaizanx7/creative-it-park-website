                        ...
                        @foreach ($client as $user)
                            <tr>
                                ...
                                <td data-label="Name"> <img style="height:50px !important; width:60px !important;"
                                        src="{{ asset('assets/uploads/client/' . $user->image) }}" alt=""></td>
                                ...
                                <td class="actions-cell">
                                    <div class="buttons right nowrap">
                                        <a href="{{ route('admin.client.edit', $user->id) }}" class="button small blue">
                                            <i class="mdi mdi-pencil" style="font-size: 16px;"></i>
                                        </a>
                                        <form action="{{ route('admin.client.destroy', $user->id) }}" method="post" onsubmit="return confirm('Are you sure?')" style="display: inline-block; margin: 0;">
                                            @csrf
                                            @method('DELETE')
