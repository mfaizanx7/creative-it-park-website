...
<link rel="stylesheet" href="https://cdn.materialdesignicons.com/5.4.55/css/materialdesignicons.min.css">
    ...
    <section class="is-hero-bar">
        <div class="flex flex-col md:flex-row items-center justify-between space-y-6 md:space-y-0">
            ...
            <a href="{{ route('admin.cloud.create') }}">
        ...
        <div class="card has-table">
            <div class="card-content">
                <table>
                    ...
                    <tbody>
                        @foreach ($cloud_services as $value)
                            <tr>
                                {{-- <td class="image-cell">
                                    <div class="image">
                                ...
                                <td class="actions-cell">
                                    <div class="buttons right nowrap">
                                        <a href="{{ route('admin.cloud.edit', $value->id) }}" class="button small blue">
                                            <i class="mdi mdi-pencil" style="font-size: 16px;"></i>
                                        </a>
                                        <form action="{{ route('admin.cloud.destroy', $value->id) }}" method="post" onsubmit="return confirm('Are you sure?')" style="display: inline-block; margin: 0;">
                                            @csrf
                                            @method('DELETE')
                ...
                <div class="admin-pagi">
                    {!! $cloud_services->appends(request()->all())->links() !!}
            </div>
            </div>
        </div>
    </section>
