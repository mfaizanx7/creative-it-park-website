    ...
    <section class="section main-section">
        <div class="card mb-6">
            ...
            <div class="card-content">
                <form method="POST" action="{{ route('admin.website.update', $web_ser_solu->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="field">
                        <label class="label">Heading</label>
                        <div class="control">
                            <input class="input" type="text" name="heading" placeholder="" value="{{$web_ser_solu->heading}}">
                        </div>
                    </div>
                    {{-- <div class="field">
                        ...
                        <div class="control">
                            <div class="select">
                                <select id="link_type_drop_downs" name="type">
                                    ...
                                    <option value="service-solution" {{ $web_ser_solu->type == 'service-solution' ? 'selected' : '' }}>Service Solution</option>
                                    <option value="service-performance" {{ $web_ser_solu->type == 'service-performance' ? 'selected' : '' }}>Service Performance</option>
                                    <option value="service-application" {{ $web_ser_solu->type == 'service-application' ? 'selected' : '' }}>Service Application</option>
                                </select>
                    ...
                    <div id="description-field" class="mb-3">
                        ...
                        <div id="editor-container">
                            ...
                            <div id="editor">{!! old('discription', $web_ser_solu->discription) !!}</div>
                        </div>
                        <textarea name="discription" id="hidden-content" style="display:none;"> {{ old('discription', $web_ser_solu->discription) }}</textarea>
